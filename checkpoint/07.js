...
LinkedList.prototype.mapHouses = function (value) {
  ...
  /**
   * Retornar false si la lista esta vacia.
   */
  ...
  while ( current ) {
    /**
     * Modificar los valores de la lista actual por lo que recibes por parámetros.
     */
    current.value = value;
    current = current.next;
  }
  /**
   * Retormar true para indicar que la operación se realizó correctamente.
   */
  return true;
}
